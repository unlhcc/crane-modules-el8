...
prepend_path("PATH",              "/util/opt/htslib/1.12/intel/20/bin")
prepend_path("LD_LIBRARY_PATH",   "/util/opt/htslib/1.12/intel/20/lib")
prepend_path("INCLUDE",           "/util/opt/htslib/1.12/intel/20/include")
prepend_path("MANPATH",		  "/util/opt/htslib/1.12/intel/20/share/man")
setenv("HTSLIB", "/util/opt/htslib/1.12/intel/20")
