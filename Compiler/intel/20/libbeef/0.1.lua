...
prepend_path("PATH",                "/util/opt/libbeef/0.1/intel/20/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/libbeef/0.1/intel/20/lib")
prepend_path("LIBRARY_PATH",        "/util/opt/libbeef/0.1/intel/20/lib")

setenv("LIBBEEF", "/util/opt/libbeef/0.1/intel/20")
