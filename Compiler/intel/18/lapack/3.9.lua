...
prepend_path("LD_LIBRARY_PATH",   "/util/opt/lapack/3.9/intel/18/lib")
prepend_path("LIBRARY_PATH",   "/util/opt/lapack/3.9/intel/18/lib")
prepend_path("PKG_CONFIG_PATH","/util/opt/lapack/3.9/intel/18/lib/pkgconfig")
setenv("LAPACK", "/util/opt/lapack/3.9/intel/18")
