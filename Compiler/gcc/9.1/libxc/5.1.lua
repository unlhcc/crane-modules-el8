...
prepend_path("PATH",                "/util/opt/libxc/5.1/gcc/9.1/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/libxc/5.1/gcc/9.1/lib")
prepend_path("INCLUDE",             "/util/opt/libxc/5.1/gcc/9.1/include")
