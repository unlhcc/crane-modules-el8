...
setenv("BOOST_DIR",	    "/util/opt/boost/1.66/gcc/10.2")
setenv("Boost_DIR",	    "/util/opt/boost/1.66/gcc/10.2")
setenv("BOOST_INCLUDE",     "/util/opt/boost/1.66/gcc/10.2/include")

-- Add boost to the LD_LIBRARY_PATH, LIBRARY_PATH
prepend_path("LD_LIBRARY_PATH",   "/util/opt/boost/1.66/gcc/10.2/lib")
prepend_path("LIBRARY_PATH",      "/util/opt/boost/1.66/gcc/10.2/lib")
prepend_path("CPATH",      "/util/opt/boost/1.66/gcc/10.2/include")
