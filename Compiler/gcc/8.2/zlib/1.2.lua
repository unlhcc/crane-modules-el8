...
prepend_path("LD_LIBRARY_PATH",     "/util/opt/zlib/1.2/gcc/8.2/lib")
prepend_path("MANPATH",             "/util/opt/zlib/1.2/gcc/8.2/share/man")
prepend_path("INCLUDE",             "/util/opt/zlib/1.2/gcc/8.2/include")
