...
prepend_path("PATH",                "/util/opt/libxc/5.2/gcc/10/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/libxc/5.2/gcc/10/lib")
prepend_path("INCLUDE",             "/util/opt/libxc/5.2/gcc/10/include")

prepend_path("CPATH",               "/util/opt/libxc/5.2/gcc/10/include")
prepend_path("LIBRARY_PATH",        "/util/opt/libxc/5.2/gcc/10/lib")

setenv("LIBXC", "/util/opt/libxc/5.2/gcc/10")
