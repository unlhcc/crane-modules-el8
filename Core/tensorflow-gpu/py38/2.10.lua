...
pushenv("CONDA_DEFAULT_ENV", "tensorflow-gpu-2.10.0-py38")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/tensorflow-gpu/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/tensorflow-gpu/envs/tensorflow-gpu-2.10.0-py38/bin")
-- Needed so TF XLA can find nvvm
setenv("XLA_FLAGS","--xla_gpu_cuda_data_dir=/util/opt/anaconda/deployed-conda-envs/packages/tensorflow-gpu/envs/tensorflow-gpu-2.10.0-py38")
