...
setenv("MKLROOT","/util/opt/intel-oneapi/2021.1.0.2659/mkl/2021.1.1")
prepend_path("LD_LIBRARY_PATH","/util/opt/intel-oneapi/2021.1.0.2659/mkl/2021.1.1/lib/intel64")
