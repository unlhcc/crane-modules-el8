...
pushenv("CONDA_DEFAULT_ENV", "ilog-cplex-22.1.0")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ilog-cplex/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/ilog-cplex/envs/ilog-cplex-22.1.0/bin")
