...
pushenv("CONDA_DEFAULT_ENV", "keras-gpu-2.6.0-py38")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/keras-gpu/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/keras-gpu/envs/keras-gpu-2.6.0-py38/bin")
