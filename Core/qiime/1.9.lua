...
prepend_path("PATH",		"/util/opt/ampliconnoise/1.27/bin")
prepend_path("PATH",		"/util/opt/ampliconnoise/1.27/Scripts")
...
setenv("PYRO_LOOKUP_FILE",	"/util/opt/ampliconnoise/1.27/Data/LookUp_E123.dat")
setenv("SEQ_LOOKUP_FILE",	"/util/opt/ampliconnoise/1.27/Data/Tran.dat")
