...
prepend_path("PATH",                "/util/opt/relion/4.0/openmpi/4.0/intel/20/bin")
prepend_path("LIBRARY_PATH",        "/util/opt/relion/4.0/openmpi/4.0/intel/20/lib")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/relion/4.0/openmpi/4.0/intel/20/lib")
load("intel-mkl/20","zlib/1.2","libtiff/4.1","libpng/1.6","libjpeg/2.0","intel-tbb/2021")
