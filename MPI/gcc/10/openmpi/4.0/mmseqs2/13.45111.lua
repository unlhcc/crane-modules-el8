help (
[[
This module loads MMseqs2 built with GCC 10.2.
...
prepend_path("PATH"    ,"/util/opt/mmseqs2/13.45111/gcc/10.2/openmpi/4.0/bin")
setenv("MMSEQS_HOME" ,"/util/opt/mmseqs2/13.45111/gcc/10.2/openmpi/4.0")
